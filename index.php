    ...
    <div class="container-fluid">
            ...
            <div class="row header-section">
                <div class="col-sm">
                    <h1 class="header-tittle">
                        <span class="header-tittle-bg">"I’m looking for the unexpected.</span> <br>
                        <span class="header-tittle-bg"> I’m looking for things I’ve never seen before."</span>
                    </h1>
                </div>
            </div>
        ...
        <div class="row portfolio-section" id="portfolio">
            ...
            <div class="col-sm-7">
                <ul class="portfolio-list">
                    ...
                    <li class="portfolio-item"><a href="#" class="portfolio-link">PANORAMAS</a></li>
                    <li class="portfolio-item"><a href="#" class="portfolio-link">PORTRAITS</a></li>
                    <li class="portfolio-item"><a href="#" class="portfolio-link">MACRO</a></li>
        ...
        <div class="row default-section">
            <div class="col-sm-6">
                ...
                <p class="text-default">Apple pie icing sweet. Brownie jelly-o applicake applicake sweet roll liquorice
                    bear claw. Jujubes carrot cake cotton candy sweet tart brownie. Tiramisu applicake jujubes.</p>
                <a class="visit-me-btn" href="#">VISIT ME</a>
            </div>
        ...
        <div class="row testimonials-section">
            ...
            <div class="col-12">
                <p class="text-testimonials">Apple pie icing sweet. Brownie jelly-o applicake applicake sweet roll
                    ...
                    jujubes.</p>
                <p class="testimonials-name">-Walter White</p>
            </div>
        </div>
        <!-- TESTIMONIALS -->
        ...
        <div class="row contact-section" id="contact">
            ...
            <div class="col-sm-6">
                ...
                <p class="contact-text">W325 State Road 123</p>
                <p class="contact-text">Mondovi, WI(Wisconsin) 98746-54321</p>
        ...
        <div class="row footer-section">
            <div class="col-sm-9 footer-options">
                <a class="footer-link" href="#">HOME</a> |
                <a class="footer-link" href="#services">SERVICES</a> |
                <a class="footer-link" href="#portfolio">PORTFOLIO</a> |
                <a class="footer-link" href="#contact">CONTACT</a>
            </div>
            <div class="col-sm-3 footer-year">2021©</div>
        </div>
        <!-- FOOTER -->
